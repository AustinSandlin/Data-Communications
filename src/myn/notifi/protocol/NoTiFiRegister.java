 ...
 *
 * This class serializes and deserializes a register message. It also stores
...
/**
 * This class serializes and deserializes a register message. It also stores the
...
public class NoTiFiRegister extends NoTiFiMessage {
    ...
    /**
     * This function creates a register object from an input stream. It converts
     * the address and port from little to big endian, per protocol.
     * 
     * @param in
     ...
     */
    public NoTiFiRegister(DataInputStream in)
        ...
        /** Read in the register data from the DataInputStream. */
     ...
     */
    public NoTiFiRegister(int msgId, Inet4Address address, int port)
            throws IllegalArgumentException {
        super(msgId);
        setAddress(address);
        setPort(port);
    ...
    /**
     * Returns the Inet4Address for the register message.
     * 
     * @return the address
     */
     ...
     * It simply needs to return the code for a register message.
     */
    public int getCode() {
        return CODE;
    }
    ...
    /**
     * Return the port for the register message.
     * 
     ...
     * takes in an object, so we need to check that it's a NoTiFiRegister too.
     */
    @Override
    public boolean equals(Object obj) {
        if (obj != null && obj instanceof NoTiFiRegister) {
            NoTiFiRegister temp = (NoTiFiRegister) obj;
