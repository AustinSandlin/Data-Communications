 ...
 *
 * This class is a JUnit 4 test for the NoTiFiLocationAddition class.
 *
 ************************************************/
...
public class NoTiFiLocationAdditionTest {
    ...
    public void testStreamConstructor()
        ...
        NoTiFiLocationAddition temp = (NoTiFiLocationAddition) NoTiFiMessage
                .decode(input);
        assertEquals(temp.getCode(), 1);
    ...
    public void testParamConstructor()
        ...
        NoTiFiLocationAddition temp = new NoTiFiLocationAddition(0, location);
        assertEquals(temp.getCode(), 1);
        assertEquals(temp.getMsgId(), 0);
        assertTrue(temp.getLocationRecord().equals(location));
    }
    ...
    public void testToString() throws IllegalArgumentException, IOException {
        ...
        assertEquals(temp.toString(),
                "version: 3, msgId: 0, code: 1, location record: userID: 77, longitude: 31.550285, latitude: -97.117215, location name: BU, location description: BAYLOR");
    }
